  ...
  mCosThetaStar(std::numeric_limits<float>::min())
{
  ...
  StPhysicalHelixD p1Helix = particle1->helix(-4.989);
  StPhysicalHelixD p2Helix = particle2->helix(-4.989);
  StPhysicalHelixD p3Helix = particle3->helix(-4.989);
  StPhysicalHelixD p4Helix = particle4->helix(-4.989);
